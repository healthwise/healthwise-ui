...
Demonstrates default rendering of the component with different groups

<Preview>
    <Story name="Different groups">
        <DropDown
            prompt="Select an item"
            nameKey="name"
            valueKey="id"
            groupKey="organizationName"
            items={[
                {
                    id: "1234",
...
Demonstrates default rendering of the component with the same group

<Preview>
    <Story name="Same group">
        <DropDown
            prompt="Select an item"
            nameKey="name"
            valueKey="id"
...
Demonstrates default rendering of the component with no groups

<Preview>
    <Story name="No groups">
        <DropDown
            prompt="Select an item"
            nameKey="name"
            valueKey="id"
